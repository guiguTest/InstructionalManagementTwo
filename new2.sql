...
CREATE TABLE `audition_info` (
  ...
  CONSTRAINT `FK_audition_discipline` FOREIGN KEY (`audition_course`) REFERENCES `discipline_info` (`discipline_name`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- ----------------------------
INSERT INTO `discipline_info` VALUES ('1', 'cs', '9800', '88', '无', 'cs');
INSERT INTO `discipline_info` VALUES ('2', 'cs1', '9800', '88', '无', 'cs');
...
-- ----------------------------
INSERT INTO `staff_info` VALUES ('1', null, 'vas', '男', '123', 'arv', '123163541', '2018-01-02 00:00:00', '1564653156', '1534531234156', 'avdvae', 'vaerv', '51564131', '2018-01-07 00:00:00', '博士', 'argvwe', '1', 'scva', 'cvas');
