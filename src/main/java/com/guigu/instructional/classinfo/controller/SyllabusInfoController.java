...
public class SyllabusInfoController {
	...
	public String addSyllabusInfo(Model model,@Validated SyllabusInfo syllabusInfo,BindingResult bindingResult) {
	...
	public String list(SyllabusInfo syllabusInfo, Model model) {
		List<SyllabusInfo> list = syllabusInfoService.getSyllabusList(syllabusInfo);
	...
	public String loadUpate(Integer syllabusId, Model model) {
		SyllabusInfo syllabusInfo = syllabusInfoService.getSyllabus(syllabusId);
