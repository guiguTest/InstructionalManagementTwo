    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-6">
                	 	...
                	 	<option></option>
                    	<option value="0" ${marketActiveVO.activeRefectEstimate=='0'?'selected':''}>好</option>
                     	<option value="1" ${marketActiveVO.activeRefectEstimate=='1'?'selected':''}>非常好</option>
                      	<option value="2" ${marketActiveVO.activeRefectEstimate=='2'?'selected':''}>非常非常的好</option>
                    </select>
                </div>
            </div>
        </div>
