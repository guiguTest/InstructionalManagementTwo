	...
	<div class="row">
        ...
        <div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">2012-2-2</p>
                </div>
            </div>
        </div>
    </div>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">2313131313@qq.com</p>
                </div>
            </div>
      	...
      	<div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">春节放假</p>
                </div>
            </div>
        </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">邮件内容</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">234242424</p>
                </div>
            </div>
