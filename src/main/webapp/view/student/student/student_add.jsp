...
<form action="${pageContext.request.contextPath}/student/student/add.action" method="post" class="form-horizontal">
   	<div class="row">
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
            	<label class="col-sm-3 control-label">负责人编号</label>
                <div class="col-sm-4">
                	<input type="text" name="staffId" value="${studentInfo.staffId }" class="form-control input-sm" placeholder="请输入负责人编号"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                	<input type="text" name="classId" value="${studentInfo.classId }"  class="form-control input-sm" placeholder="请输入班级编号"/>
                </div>
            </div>
        </div>
    </div>
   ...
   <!--开始 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentBirthday" value="${studentInfo.studentBirthday}" onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入出生日期"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
   ...
   <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentIspay" value="${studentInfo.studentIspay}" class="form-control input-sm" placeholder="是否缴费"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentMark" value="${studentInfo.studentMark}" class="form-control input-sm" placeholder="标识"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">描述信息</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<textarea name="studentDesc" value="${studentInfo.studentDesc}" class="form-control"></textarea>
                </div>
            </div>
