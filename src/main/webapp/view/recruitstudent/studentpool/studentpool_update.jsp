...
<form action="${pageContext.request.contextPath}/recruitstudent/studentpool/update.action" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentId" readonly="readonly" value="${studentInfo.studentId }" class="form-control input-sm" placeholder="请输入学生编号"/>
                </div>
            </div>
        </div>
            	<div class="col-sm-5">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentName" value="${studentInfo.studentName }" class="form-control input-sm" placeholder="请输入学生姓名"/>
                </div>
            </div>
        </div>
    </div>
   ...
   <!--结束 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentProCity" name="studentParentsPhone" value="${studentInfo.studentProCity }" class="form-control input-sm" placeholder="请输入城市"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">描述信息</h5>
		...
		<div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="studentIspay" value="${studentInfo.studentIspay }" class="form-control input-sm" placeholder="请输入是否付款"/>
                </div>
            </div>
        </div>
    </div>
