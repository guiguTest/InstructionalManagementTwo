...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/recruitstudent/trackrecord/update.action"
		class="form-horizontal">
		<h5 class="page-header alert-info"
			style="padding: 10px; margin: 0px; margin-bottom: 5px;">基本信息</h5>
		<div class="row">
			<input type="hidden" name="trackRecordId"
				value="${trackRecordInfo.trackRecordId }"
