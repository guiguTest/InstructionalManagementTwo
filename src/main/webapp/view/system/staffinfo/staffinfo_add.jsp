...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/system/staffinfo/add.action"
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="staffId" readonly="readonly"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="staffIdcard"
							value="${staffInfo.staffIdcard}" class="form-control input-sm" />
					</div>
				</div>
			</div>
		</div>
