...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/system/staffinfo/list.action"
	...
	<div class="row" style="padding: 15px; padding-top: 0px;" align="right">
		...
		<display:table class="table table-condensed table-striped" name="list"
			...
			<display:column property="staffName" title="姓名"
				href="${pageContext.request.contextPath }/system/staffinfo/show.action"
			...
			<display:column
				href="${pageContext.request.contextPath }/system/staffinfo/load.action"
				paramId="staffId" paramProperty="staffId" value="修改" title="修改"></display:column>
			<display:column
				href="${pageContext.request.contextPath }/system/staffinfo/delete.action"
