...
<form action="${pageContext.request.contextPath}/classinfo/teacher/update.action" method="post" class="form-horizontal">
   	<div class="row">
	...
	<div class="row">
       ...
       <input type="hidden" value="${staffInfo.staffId }" name="staffId" readonly="readonly" class="form-control input-sm"/>
