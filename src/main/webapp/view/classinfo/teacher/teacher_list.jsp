...
<form class="form-inline" action="${pageContext.request.contextPath}/classinfo/teacher/list.action" method="post">
...
<div class="row" style="padding:15px; padding-top:0px; ">
    ...
    <display:table class="table table-condensed table-striped" name="list" pagesize="10" requestURI="${pageContext.request.contextPath }/classinfo/teacher/list.action">
    	<display:column property="staffId" title="编号"></display:column>
    	<display:column property="staffName" title="姓名" href="${pageContext.request.contextPath }/classinfo/teacher/show.action" paramId="staffId" paramProperty="staffId"></display:column>
    	...
    	<display:column href="${pageContext.request.contextPath }/classinfo/teacher/load.action" paramId="staffId" paramProperty="staffId" value="修改" title="修改"></display:column>
    	<display:column href="${pageContext.request.contextPath }/classinfo/teacher/delete.action" paramId="staffId" paramProperty="staffId" value="删除" title="删除"></display:column>
