	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" value="${syllabusInfo.syllabusId}" name="syllabusId" readonly="readonly" class="form-control input-sm" placeholder="请输入编号"/>
                </div>
            </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
              ...
              <a class="btn btn-warning" href="syllabusinfo_list.jsp">返回上一级</a>
        </div>
    </div>
</form>
