...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/finance/salary/add.action"
		class="form-horizontal">
		<h5 class="page-header alert-info"
			style="padding: 10px; margin: 0px; margin-bottom: 5px;">基本信息</h5>
		<div class="row">
			<input type="hidden" name="staffSalaryId"
			...
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="staffId" value="${staffSalary.staffId }"
							class="form-control input-sm" />
					</div>
				</div>
			</div>
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" name="staStaffId"
							value="${staffSalary.staStaffId }" class="form-control input-sm" />
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select class="form-control input-sm" name="staffSalaryIsused">
							<option></option>
							<option ${staffSalary.staffSalaryIsused=='是'?'selected':''}
								value="是">是</option>
							<option ${staffSalary.staffSalaryIsused=='否'?'selected':''}
								value="否">否</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="staffSalaryTime"
							value="<fmt:formatDate value="${staffSalary.staffSalaryTime}" pattern="yyyy-MM-dd"/>"
